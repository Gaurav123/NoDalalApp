   ...
   //list view
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv= findViewById(R.id.proglist);
         final String[] values ={"SERVICES OFFERED","HOTELS & INFO","ABOUT US"};
        ArrayAdapter arrayadapter;
        arrayadapter = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_list_item_1, Arrays.asList(values));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (values[position].equals(values[0])){
                    ...
                    Intent intent=new Intent(MainActivity.this, hotelmain.class);
                    startActivity(intent);
