        ...
        btnsignin1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email1.isEmpty()){
                    ...
                    mFirebaseauth1.signInWithEmailAndPassword(email1,pwd1).addOnCompleteListener(registeractivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                makeText(registeractivity.this,"login error,Please Try Again",Toast.LENGTH_SHORT).show();
                            }
                            else{

                                Intent intohome=new Intent(registeractivity.this,account.class);
